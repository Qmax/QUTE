...
public:
    ...
    virtual void moveVertical1Cursors(double)=0;
    virtual void moveVertical2Cursor(double)=0;
    virtual void moveHorizontal1Cursors(double)=0;
    virtual void moveHorizontal2Cursors(double)=0;
