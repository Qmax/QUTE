...
public:
    ...
    virtual QVector<QPointF> getWavePoints()=0;
...
public:
    ...
    virtual QVector<QPointF> getWavePoints()
    {
...
public:
    ...
    virtual IWaveProduct* getPatternProduct(QString);
};
...
public:
    ...
    IWaveProduct* getPatternProduct(QString pStrproduct)
    {
        if(pStrproduct == "Oscillator")
        {
