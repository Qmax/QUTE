...
public:
    ...
    void GetDriveSlopeConstant();
    void readADCCalibrationFile(double,double);
    ...
    short m_nADC,m_nADCGain;
    unsigned int m_nModeRegister,m_nConfigurationRegister;
    unsigned int m_nADC1Voltage;
    double l_nFactor1, l_nFactor2, l_nAIN;
...
//    QLineEdit *m_objLE_RxedVoltage;
    ...
    double m_nRangeSlope[4][5],m_nRangeConstant[4][5],m_nXVoltage[4][5],m_nYVoltage[4][5];
    double m_nRefRangeSlope[5],m_nRefRangeConstant[5];
    double m_nRangeSlopeRx,m_nRangeConstantRx;
    double XVoltage[4][5][5],YVoltage[4][5][5];
    ...
    double m_nDrvSlope[5],m_nDrvConstant[5];
    short whichDrive;
...
private slots:
    void on_Calibrated_4_clicked(bool checked);
    void on_checkBox_2_clicked(bool checked);
    void on_Calibrated_3_clicked(bool checked);
    void on_Calibrated_clicked(bool checked);
    void on_stopBut_clicked();
    void on_loopbck_clicked(bool checked);
    void on_Calibrated_2_clicked(bool checked);
