...
public:
    ...
    void setupUi(QWidget *DACCalibrationClass)
    {
        ...
        DACCalibrationClass->resize(400, 407);
...
"}"));
        ...
        CalibBox->setGeometry(QRect(5, 2, 391, 391));
...
" }"));
        ...
        driveBut->setGeometry(QRect(230, 90, 93, 30));
...
" }"));
        ...
        lineEdit_3->setGeometry(QRect(110, 140, 100, 25));
...
" }"));
        ...
        nextBut->setGeometry(QRect(230, 140, 93, 30));
...
" }"));
        ...
        slope->setGeometry(QRect(90, 190, 90, 26));
        slope->setFont(font1);
...
" }"));
        ...
        saveBut->setGeometry(QRect(170, 340, 93, 30));
...
" }"));
        ...
        exitBut->setGeometry(QRect(280, 340, 93, 30));
...
" }"));
        ...
        label_7->setGeometry(QRect(362, 42, 20, 20));
        ...
        lineEdit_4->setGeometry(QRect(110, 244, 70, 25));
...
" }"));
        ...
        Calibrated->setGeometry(QRect(190, 240, 93, 25));
        Calibrated->setFont(font);
        groupBox = new QGroupBox(CalibBox);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(4, 220, 382, 110));
...
" "));
        ...
        lineEdit_5->setGeometry(QRect(108, 60, 100, 25));
...
" }"));
        ...
        label_9->setGeometry(QRect(10, 60, 80, 20));
        label_9->setFont(font);
        driveBut_3 = new QPushButton(groupBox);
        driveBut_3->setObjectName(QString::fromUtf8("driveBut_3"));
        driveBut_3->setGeometry(QRect(294, 60, 84, 30));
        driveBut_3->setFont(font);
        driveBut_3->setStyleSheet(QString::fromUtf8(" QPushButton {\n"
"     border: 2px solid #8f8f91;\n"
"     border-radius: 10px;\n"
"     background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,\n"
"                                       stop: 0 #f6f7fa, stop: 1 #dadbde);\n"
...
" }"));
        ...
        comboBox_2->setGeometry(QRect(217, 60, 70, 25));
...
""));
        ...
        label_10->setGeometry(QRect(117, 88, 80, 17));
        samples = new QLabel(CalibBox);
        samples->setObjectName(QString::fromUtf8("samples"));
        samples->setGeometry(QRect(330, 144, 31, 20));
        CalibratedRef = new QCheckBox(CalibBox);
        CalibratedRef->setObjectName(QString::fromUtf8("CalibratedRef"));
        CalibratedRef->setGeometry(QRect(10, 343, 160, 25));
        CalibratedRef->setFont(font);
        CalibratedRef->setChecked(true);
        groupBox->raise();
        label->raise();
        lineEdit->raise();
        label_2->raise();
    ...
    void retranslateUi(QWidget *DACCalibrationClass)
    {
        ...
        CalibBox->setTitle(QApplication::translate("DACCalibrationClass", "VI DRIVE/RECEIVE CALIBRATION PANEL", 0, QApplication::UnicodeUTF8));
        ...
        comboBox->insertItems(0, QStringList()
         ...
         << QApplication::translate("DACCalibrationClass", "2", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DACCalibrationClass", "4", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DACCalibrationClass", "8", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DACCalibrationClass", "14", 0, QApplication::UnicodeUTF8)
        );
        ...
        label_9->setText(QApplication::translate("DACCalibrationClass", "Rxed Volt:", 0, QApplication::UnicodeUTF8));
        driveBut_3->setText(QApplication::translate("DACCalibrationClass", "STOP", 0, QApplication::UnicodeUTF8));
        comboBox_2->clear();
        ...
        CalibratedRef->setText(QApplication::translate("DACCalibrationClass", "Calibrated Reference", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
