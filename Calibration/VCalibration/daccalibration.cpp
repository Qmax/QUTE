...
void DACCalibration::on_driveBut_2_clicked()
{
    ...
    {
        qDebug()<<"DAC Output-Before"<<m_nDACOutput;
    	qDebug()<<"Gain:"<<m_nRangeSlope[ui.comboBox->currentIndex()]<<"Constant:"<<m_nRangeConstant[ui.comboBox->currentIndex()];
...
void DACCalibration::on_saveBut_clicked()
{
    ...
    objCalibration.writeStartElement("VCalibration");
...
void DACCalibration::readParallelDACCalibrationFile(){
    ...
    QString l_strFilename="ParallelDACDriveCalibration.xml";
