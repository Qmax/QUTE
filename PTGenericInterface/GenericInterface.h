#ifndef IGENERICINTERFACE_H
#define IGENERICINTERFACE_H
...
class IGenericInterface
{
    ...
    virtual void setDSOTriggerSource(RECEIVER_CONF,DSO_TRIGGER)=0;
    ...
    virtual void writeBaseAddress(unsigned int)=0;
};
Q_DECLARE_INTERFACE(IGenericInterface,"pt.GenericInterface/1.0.0.1");

#endif // IGENERICINTERFACE_H
