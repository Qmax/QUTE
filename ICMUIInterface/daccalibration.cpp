    ...
    : QWidget(parent)
{
        ...
        connect(parent,SIGNAL(ICM2GCalib(double,QString)),this,SLOT(ICM2GCalib(double,QString)));

}
void DACCalibration::ICM2GCalib(double value,QString com){
	if(com==ui.comboBox->currentText()){
...
//    connect(m_objLE_RxedValue, SIGNAL(focussed(bool)), this, SLOT(callRxedValueEdit()));
    ...
    ui.ICM->clear();
    ui.ICM->insertItem(0,"5E");
    ui.ICM->insertItem(1,"50E");
    ui.ICM->insertItem(2,"500E");
    ui.ICM->insertItem(3,"5KE");
    ui.ICM->insertItem(4,"50KE");
    ui.ICM->insertItem(5,"500KE");
...
//        emit GCalib2ICM(pValue,ui.comboBox->currentText());
        break;
    case 2:
        m_nRxedValue=pValue;
        break;
