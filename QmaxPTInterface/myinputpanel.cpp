      ...
      lastFocusedWidget(0)
{
    ...
    signalMapper.setMapping(form.panelButton_OK,form.panelButton_OK);
    signalMapper.setMapping(form.panelButton_CANCEL,form.panelButton_CANCEL);
    ...
    connect(form.panelButton_hash, SIGNAL(clicked()),
            &signalMapper, SLOT(map()));
    connect(form.panelButton_OK,SIGNAL(clicked()),
            &signalMapper,SLOT(map()));
    connect(form.panelButton_CANCEL,SIGNAL(clicked()),
            &signalMapper,SLOT(map()));
