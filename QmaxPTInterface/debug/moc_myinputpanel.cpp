...
**
** Created: Mon Sep 1 11:58:25 2014
...
static const char qt_meta_stringdata_MyInputPanel[] = {
    ...
    "characterGenerated(QChar)\0closePanel()\0"
...
int MyInputPanel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: closePanel(); break;
        case 2: saveFocusWidget((*reinterpret_cast< QWidget*(*)>(_a[1])),(*reinterpret_cast< QWidget*(*)>(_a[2]))); break;
        case 3: buttonClicked((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
