...
**
** Created: Tue Sep 30 16:46:16 2014
...
static const char qt_meta_stringdata_PlotterWidget[] = {
    "PlotterWidget\0"
};

const QMetaObject PlotterWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PlotterWidget,
      qt_meta_data_PlotterWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PlotterWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlotterWidget))
