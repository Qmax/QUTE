...
//~~~~~~HIDE UNWANTED~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	ui->continuousBut->setVisible(false);
	ui->continuousCap->setVisible(false);
	ui->GateBut->setVisible(false);
	ui->GateCap->setVisible(false);
	ui->singleBut->setVisible(false);
	ui->singleCap->setVisible(false);
...
void FG::HighlightButtons(int but){
	...
	case SINGLE:
		...
		ui->continuousBut->setStyleSheet(knobOFF);
		ui->singleBut->setStyleSheet(knobON);
		ui->GateBut->setStyleSheet(knobOFF);
		ui->burstBut->setStyleSheet(knobOFF);

		//ui->MANBut->setStyleSheet(pressed);
		ui->INTBut->setStyleSheet(normal);
		ui->EXTBut->setStyleSheet(normal);
	...
	case CONTINUOUS:
		...
		ui->continuousBut->setStyleSheet(knobON);
		ui->singleBut->setStyleSheet(knobOFF);
		ui->GateBut->setStyleSheet(knobOFF);
		ui->burstBut->setStyleSheet(knobOFF);

		ui->MANBut->setStyleSheet(normal);
		ui->INTBut->setStyleSheet(normal);
		ui->EXTBut->setStyleSheet(normal);
	...
	case BURST:
		...
		ui->singleBut->setStyleSheet(knobOFF);
		ui->GateBut->setStyleSheet(knobOFF);
		ui->burstBut->setStyleSheet(knobON);
	...
	case GATE:
		...
		ui->continuousBut->setStyleSheet(knobOFF);
		ui->singleBut->setStyleSheet(knobOFF);
		ui->GateBut->setStyleSheet(knobON);
		ui->burstBut->setStyleSheet(knobOFF);
	...
	case MANUAL:
		...
		ui->MANBut->setStyleSheet("QPushButton{background-color:rgba(0,0,0,0);border:1px solid rgba(0,0,0,0);image: url(:/res/pressed.svg);}QPushButton::pressed{background-color:rgba(0,0,0,0);border:1px solid rgba(0,0,0,0);image: url(:/res/pressedRed.png);}QPushButton::released{background-color:rgba(0,0,0,0);border:1px solid rgba(0,0,0,0);image: url(:/res/pressed.svg);}");
		ui->INTBut->setStyleSheet(normal);
		ui->EXTBut->setStyleSheet(normal);
		break;
	case INT:
		...
		ui->MANBut->setStyleSheet(normal);
		ui->INTBut->setStyleSheet(pressed);
		ui->EXTBut->setStyleSheet(normal);
		break;
	case EXT:
		...
		ui->MANBut->setStyleSheet(normal);
		ui->INTBut->setStyleSheet(normal);
		ui->EXTBut->setStyleSheet(pressed);
		break;
...
void FG::on_modeBox_currentIndexChanged(int index)
{
    switch(index){
    case 0:
        ui->continuousBut->animateClick(1);
        break;
    case 1:
