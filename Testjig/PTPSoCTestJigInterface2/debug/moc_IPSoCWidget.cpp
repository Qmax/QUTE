...
**
** Created: Thu Aug 14 14:50:28 2014
...
void *IPSOCWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IPSOCTestJigInterface2"))
        return static_cast< IPSOCTestJigInterface2*>(const_cast< IPSOCWidget*>(this));
    if (!strcmp(_clname, "pt.PSOCTestJigInterface2/1.0.0.1"))
        return static_cast< IPSOCTestJigInterface2*>(const_cast< IPSOCWidget*>(this));
