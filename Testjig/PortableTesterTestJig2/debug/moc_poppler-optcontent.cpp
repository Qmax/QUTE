...
**
** Created: Sat May 18 17:00:30 2013
...
static const char qt_meta_stringdata_Poppler__OptContentModel[] = {
    "Poppler::OptContentModel\0"
};

const QMetaObject Poppler::OptContentModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_Poppler__OptContentModel,
      qt_meta_data_Poppler__OptContentModel, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Poppler::OptContentModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Poppler__OptContentModel))
