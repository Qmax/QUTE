...
ISLA118P50Component::ISLA118P50Component(IApplicationCardInterface *pobj){
    objAppcard = pobj;
...
void ISLA118P50Component::configureADCChip(){

}

unsigned short ISLA118P50Component::readChipVersion(){
...
unsigned short ISLA118P50Component::readChipID(){
