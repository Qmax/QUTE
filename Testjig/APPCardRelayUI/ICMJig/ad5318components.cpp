...
void AD5318Components::configureAD5318DACCW(AD5318_ctrlTemplate pDACAD5318CW)
{
...
void AD5318Components::configureAD5318DACData(AD5318_dataTemplate pDACAD5318Data)
{
...
void AD5318Components::configureADC5318CW()
{
...
void AD5318Components::configureADC5318Data(AD5318_dataTemplate pstDAC)
{
...
unsigned short  AD5318Components::convertToDecimalValue(double pVout,double pVref,bool bUnipolar,AD5318_DACSELECT p_eDACSelect)
{
    unsigned int l_nD=0x0;
     if( bUnipolar == false && (p_eDACSelect == DACF|| p_eDACSelect == DACG))
       l_nD = ((pVout*GAINVALUE)+5.0) * pow(2,DACResoultion) / 10.0;
    	// l_nD = ((pVout/GAINVALUE) * pow(2,DACResoultion)) / pVref;
     else if( bUnipolar == true)
       l_nD = ((pVout/GAINVALUE) * pow(2,DACResoultion)) / pVref;
     qDebug()<<"DAC Digital Value:"<<l_nD;
     //cout << "DAC Digital Value:"<<l_nD<<endl;
     return l_nD;
}
