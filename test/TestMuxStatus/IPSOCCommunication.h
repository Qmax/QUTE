...
public:
    ...
    virtual unsigned int FG_Scope1(unsigned int fg_state,unsigned int scope1_range)=0;
    virtual unsigned int FG_Scope2(unsigned int fg_state,unsigned int scope2_range)=0;
