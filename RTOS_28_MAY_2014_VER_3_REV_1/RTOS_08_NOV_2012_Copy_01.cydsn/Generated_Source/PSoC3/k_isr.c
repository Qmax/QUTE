...
void k_isr_Start(void)
{
    ...
    /* Set the priority. */
    k_isr_SetPriority(k_isr_INTC_PRIOR_NUMBER);
...
*   the component has been started use k_isr_StartEx instead.
*
*
* Parameters:
*   address: Address of the ISR to set in the interrupt vector table.
...
*   or k_isr_StartEx will override any effect this method would have had. 
*	This method should only be called after k_isr_Start or 
...
uint8 k_isr_GetState(void) 
{
    ...
    return (*k_isr_INTC_SET_EN & k_isr__INTC_MASK) ? 1:0;
}
