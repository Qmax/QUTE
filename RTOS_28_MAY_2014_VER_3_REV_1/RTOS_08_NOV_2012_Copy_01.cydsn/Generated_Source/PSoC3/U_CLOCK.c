...
{
    if (U_CLOCK_CLKEN & U_CLOCK_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void U_CLOCK_SetModeRegister(uint8 clkMode) 
{
    U_CLOCK_MOD_SRC |= clkMode & U_CLOCK_MODE_MASK;
}
...
*
*******************************************************************************/
void U_CLOCK_ClearModeRegister(uint8 clkMode) 
{
    U_CLOCK_MOD_SRC &= ~clkMode | ~U_CLOCK_MODE_MASK;
}
...
{
    return U_CLOCK_MOD_SRC & U_CLOCK_MODE_MASK;
}
...
void U_CLOCK_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        U_CLOCK_MOD_SRC |= CYCLK_SSS;
        U_CLOCK_MOD_SRC =
            (U_CLOCK_MOD_SRC & ~U_CLOCK_SRC_SEL_MSK) | clkSource;
    }
