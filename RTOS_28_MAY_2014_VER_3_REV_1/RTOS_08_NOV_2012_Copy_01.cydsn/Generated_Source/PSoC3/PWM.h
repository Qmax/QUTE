...
#define PWM_INIT_INTERRUPTS_MODE     ((0u << PWM_STATUS_TC_INT_EN_MASK_SHIFT) | (0 << PWM_STATUS_CMP2_INT_EN_MASK_SHIFT) | (0 << PWM_STATUS_CMP1_INT_EN_MASK_SHIFT ) | (0 << PWM_STATUS_KILL_INT_EN_MASK_SHIFT ))
