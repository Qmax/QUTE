...
void  SPIS_PutArray(const uint16 buffer[], uint8 byteCount) ;
...
#define SPIS_INT_ON_TX_EMPTY    (uint8)(1u << SPIS_STS_TX_FIFO_EMPTY_SHIFT)
...
***************************************/
    ...
    #define SPIS_TX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
        ...
        #define SPIS_RXDATA_PTR                (  (reg16  *) \
        ...
        #else /* 16bit - SPIS */
            #define SPIS_TXDATA_ZERO_REG           (* (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_A0_REG)
            ...
            #define SPIS_TXDATA_REG                (* (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_F0_REG)

            #define SPIS_TXDATA_PTR                (  (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_F0_REG)

            #define SPIS_RXDATA_REG                (* (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR16_Dp_u0__16BIT_F1_REG)
