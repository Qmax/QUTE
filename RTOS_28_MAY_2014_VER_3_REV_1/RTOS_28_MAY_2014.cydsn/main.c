...
void os (void) _task_ OS			//	FUNCTION OF 'OS' IS TO CREATE TASK'S 1 2 & 3 AND DELETE ITSELF
{
	...
	U_CLOCK_SetDividerValue(78);//38);	//	CLOCK DIVIDER INITIALISATION BAUD RATE SET AT 38400 BAUD RATE-> 19-08-2013
    ...
    QuadDecoder_SetCounter(-127);     //ADDED BY RRV FOR V3R1
    ...
    CyPins_SetPin(SRC_0_P2_6);      //  Default 1K
