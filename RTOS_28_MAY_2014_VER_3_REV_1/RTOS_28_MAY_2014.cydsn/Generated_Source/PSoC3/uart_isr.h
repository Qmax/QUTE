...
#include <cyfitter.h>
        ...
        #include <intrins.h>
        #define uart_isr_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
    #endif
#endif
...
#define uart_isr_INTC_VECTOR            ((reg16 *) uart_isr__INTC_VECT)
...
#define uart_isr_INTC_SET_EN            ((reg8 *) uart_isr__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the uart_isr interrupt. */
#define uart_isr_INTC_CLR_EN            ((reg8 *) uart_isr__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the uart_isr interrupt state to pending. */
#define uart_isr_INTC_SET_PD            ((reg8 *) uart_isr__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the uart_isr interrupt. */
#define uart_isr_INTC_CLR_PD            ((reg8 *) uart_isr__INTC_CLR_PD_REG)
