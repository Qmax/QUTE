...
**
** Created: Fri Jun 20 13:32:46 2014
...
void *SPIController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ISPIInterface"))
        return static_cast< ISPIInterface*>(const_cast< SPIController*>(this));
    if (!strcmp(_clname, "pt.SPIInterface/1.0.0.1"))
        return static_cast< ISPIInterface*>(const_cast< SPIController*>(this));
