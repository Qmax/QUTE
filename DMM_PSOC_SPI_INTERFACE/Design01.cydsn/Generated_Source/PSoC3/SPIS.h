...
#define SPIS_INT_ON_SPI_DONE    (uint8)(1u << SPIS_STS_SPI_DONE_SHIFT)
...
#define SPIS_INT_ON_BYTE_COMP   (uint8)(1u << SPIS_STS_BYTE_COMPLETE_SHIFT)
...
#define SPIS_INT_ON_RX_EMPTY     (uint8)(1u << SPIS_STS_RX_FIFO_EMPTY_SHIFT)
...
#define SPIS_INT_ON_RX_FULL      (uint8)(1u << SPIS_STS_RX_FIFO_FULL_SHIFT)
...
***************************************/
    ...
    #define SPIS_TX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
        ...
        #define SPIS_TX_AUX_CONTROL_DP1_REG   (* (reg8 *) \
                SPIS_BSPIS_es2_SPISlave_sR8_DpMISO_u1__DP_AUX_CTL_REG)
        ...
        #define SPIS_TXDATA_ZERO_REG          (* (reg8  *) \
                SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__A0_REG)
        ...
        #define SPIS_TXDATA_REG                (* (reg8  *) \
                SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__F0_REG)

        #define SPIS_TXDATA_PTR                (  (reg8  *) \
                SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__F0_REG)

        #define SPIS_RXDATA_REG                (* (reg8  *) \
                SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__F1_REG)
        ...
        #define SPIS_RXDATA_PTR                (  (reg8  *) \
            ...
            #define SPIS_TXDATA_ZERO_REG           (* (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__16BIT_A0_REG)
            ...
            #define SPIS_TXDATA_REG                (* (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__16BIT_F0_REG)

            #define SPIS_TXDATA_PTR                (  (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__16BIT_F0_REG)

            #define SPIS_RXDATA_REG                (* (reg16  *) \
                    SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__16BIT_F1_REG)
    ...
    #define SPIS_TX_AUX_CONTROL_DP0_REG       (* (reg8 *) \
            SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__DP_AUX_CTL_REG)
    #define SPIS_TX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
            SPIS_BSPIS_es3_SPISlave_sR8_Dp_u0__DP_AUX_CTL_REG)
    ...
    #define SPIS_RX_AUX_CONTROL_DP0_PTR       (  (reg8 *) \
        ...
        #define SPIS_TX_AUX_CONTROL_DP1_REG   (* (reg8 *) \
                SPIS_BSPIS_es3_SPISlave_sR8_Dp_u1__DP_AUX_CTL_REG)
        #define SPIS_TX_AUX_CONTROL_DP1_PTR   (  (reg8 *) \
                SPIS_BSPIS_es3_SPISlave_sR8_Dp_u1__DP_AUX_CTL_REG)
